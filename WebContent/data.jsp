    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">	
            <li class="active"><a href="search_by_id.jsp"><i class="fa fa-circle-o"></i> 按ID查询</a></li>
            <li class="active"><a href="search_by_modelid.jsp"><i class="fa fa-circle-o"></i> 按型号查询</a></li>
            <li class="active"><a href="advancedSearch.jsp"><i class="fa fa-circle-o"></i> 高级查询</a></li>
          </ul>
        </li>
