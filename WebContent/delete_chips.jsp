  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form role="form" action="adminDeleteChips" method="post">
                <!-- text input -->
                <div class="form-group">
                  <label>芯片名称<input type="checkbox" name="bychipname" ></label> 	
                  <input type="text" class="form-control" placeholder="请输入芯片名称" name="chipName">
                </div>
                
               
                <div class="form-group">
                  <label>芯片型号<input type="checkbox" name="bymodelid" ></label>
                  <input type="text" class="form-control" placeholder="请输入芯片型号" name="modelid">
                  
                </div>
				
				<div class="form-group">
                  <label>芯片ID<input type="checkbox" name="bychipid" ></label>
                  <input type="text" class="form-control" placeholder="请输入芯片ID" name="chipid">
                  
                </div>
				
                	<span class="input-group-btn">
                      <button type="submit" class="btn btn-info btn-flat">给我搜!</button>
                    </span>
                </div>
            </form>
        </div>
