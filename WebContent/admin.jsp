      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="export_database.jsp"><i class="fa fa-circle-o"></i> 批量导入\导出芯片信息</a></li>
          </ul>
        </li>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content" >
              <span class="info-box-text">芯片总数</span>
              <span class="info-box-number" id="chip-num"></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
			...
			<div class="info-box-content" >
              <span class="info-box-text">功能总数</span>
              <span class="info-box-number" id="func-num"></span>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
			...
			<div class="info-box-content" >
              ...
              <span class="info-box-number" id="admin-num"></span>
            </div>
                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-left"><%=adminID %></span>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                    <li>
                      ...
                      <a class="users-list-name" href="#"><%=adminID %></a>
                ...
                <table class="table no-margin">
                  ...
                  <tbody>
                  	<tr onclick="location.href='showChipsDetail.action?modelID=<s:property value="#chips.ModelID"/>'">
                  		...
                  		<td>
                  			<s:property value="#chips.ChipName"/>
                  		</td>
                  		<td>
                 		...
                 		<td> 
                  		...
                  		<td>
                  			<s:property value="#chips.searchFreq"/>
                  		</td>
                	</tr>
                  </tbody>
                  </s:iterator>
...
<script src="js/adminGetInfo.js"></script>
<!-- Morris.js charts -->
